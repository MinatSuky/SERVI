...
const MenuPagePeincipalCuenta = () => {
    return (
        <div className="Botones1 px-7 absolute left-0 top-[65px] flex flex-col justify-center items-center bg-gradient-to-r from-blue-600 to-purple-700 w-[100%] h-[45vh]">
            ...
            <p className='TextShadow font-serif mt-8 flex items-center gap-2'> <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 8 8"><path fill="#ffffff" d="M3 0v1h4v5H3v1h5V0zm1 2v1H0v1h4v1l2-1.5z"/></svg></span> CERRAR SESION</p>

...
const PagePrincipal = () => {
    return (
        <div className='container3'>
            <BarraPagePrincipal />
            <div className='h-[15vh] Invisibles'>
            ...
            <div className='SesionPagePrincipal flex'>
                ...
                <div className="w-[50%] Contenedor2 flex flex-col justify-center items-center">
                    ...
                    <p className='text-gray-600 text-lg text-center'>Ahora puedes registrar cualquiera de tus vehiculos</p>
                    <img
                        className="w-[80%]"
                ...
                <div className="w-[50%] Contenedor1 flex flex-col justify-center items-center">
                    <div className="flex w-full flex-col items-center justify-center gap-10">
                       <Link to={'/SesionCicla'} className='border cicla hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-indigo-300/50 duration-300 w-[40%] hover:w-[45%] cursor-pointer h-[12vh] rounded-3xl flex justify-center hover:gap-32 gap-8 items-center'>                      
                        ...
                        <div className='border moto hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-indigo-300/80 duration-300 w-[40%] hover:w-[45%] cursor-pointer h-[12vh] rounded-3xl flex justify-center hover:gap-32 gap-8 items-center'>
                        ...
                        <div className='border carro hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-indigo-300/100 duration-300 w-[40%] hover:w-[45%] cursor-pointer h-[12vh] rounded-3xl flex justify-center hover:gap-32 gap-8 items-center'>

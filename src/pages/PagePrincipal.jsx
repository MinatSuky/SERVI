            ...
            <div className='SesionPagePrincipal flex'>
                ...
                <div className="w-[50%] Contenedor1 flex flex-col justify-center items-center">
                    <div className="flex w-full flex-col items-center justify-center gap-10">
                        <div className='border cicla hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-indigo-300/50 duration-300 w-[40%] hover:w-[45%] cursor-pointer h-[12vh] rounded-3xl flex justify-center hover:gap-32 gap-8 items-center'>
